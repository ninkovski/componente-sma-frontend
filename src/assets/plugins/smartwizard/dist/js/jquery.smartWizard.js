  ...
  var SmartWizard = /*#__PURE__*/function () {
    ...
    _createClass(SmartWizard, [{
      ...
      value: function _createToolbar(position) {
        ...
        // var btnNext = this.options.toolbarSettings.showNextButton !== false ? $('<button></button>').text('Anterior').addClass('btn sw-btn-next').attr('type', 'button') : null;
        // var btnPrevious = this.options.toolbarSettings.showPreviousButton !== false ? $('<button></button>').text('Siguiente').addClass('btn sw-btn-prev').attr('type', 'button') : null;
